...
export const ContactSection = () => {
    ...
    const sendEmail = (e: React.SyntheticEvent) => {
        ...
        if (!serviceId || !templateId || !publicKey) {
            toast.error("Erro nas configurações de envio de e-mail.")
            return
        }
        ...
        emailjs
            ...
            .then(
                ...
                (error) => {
                    ...
                    toast.dismiss(loadingToast)
                    toast.error(`Falha ao enviar a mensagem: ${error.text}`)
                }
            )
    }
    ...
    return (
        <section className="pb-25 pt-45 px-6.5 overflow-x-hidden text-N8 md:py-60 md:px-[12.5%]">
            <div>
                <h1 className="mb-4 font-[impact] text-[2.25rem] text-center md:text-5xl">
                    Para onde podemos te levar?
                </h1>
                <p className="font-Montserrat text-sm text-center md:text-[1.75rem]">
                    Vamos entender e encontrar o melhor plano para escalar seu negócio
                </p>
                ...
                <div className="flex flex-col md:items-center md:mt-15 xl:flex-row xl:gap-30 3xl:gap-[15vw]">
                    <div className="mt-10 mb-15 bg-N3 rounded-lg p-4 w-full max-w-180 sm:mx-0 md:px-8 md:py-12 xl:mb-0 xl:mt-0">
                        <form
                            ref={form}
                            onSubmit={sendEmail}
                            className="flex flex-col gap-6 text-N8"
                        >
                            <div className="grid grid-cols-2 grid-rows-1 gap-x-3">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="nome" className="font-bold md:text-2xl">
                                        Nome
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="sobrenome" className="font-bold md:text-2xl">
                                        Sobrenome
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="email" className="font-bold md:text-2xl">
                                    Email
                                </label>
                                <input
                                    type="email"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="telefone" className="font-bold md:text-2xl">
                                    Número
                                </label>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="mensagem" className="font-bold md:text-2xl">
                                    Mensagens
                                </label>
                                <textarea
                                    name="mensagem"
                            ...
                            <button
                                type="submit"
                                className="cursor-pointer py-3 rounded-lg bg-R5 font-Montserrat text-lg font-bold text-N1 transition-all ease-in-out duration-300 hover:bg-R4"
                            >
                                Enviar
                            </button>
                        </form>
                    ...
                    <div className="flex flex-col gap-5 md:justify-center md:gap-18">
                        <div className="flex items-start gap-5">
                            ...
                            <div className="flex flex-col justify-center items-start gap-2">
                                <h2 className="mb-1 font-[impact] text-[2rem]">
                                    Converse com nós
                                </h2>
                                <p className="font-Montserrat text-sm text-N5 md:text-lg">
                                    Nossa equipe está ativa para ajudar
                                </p>
                                <p className="font-Montserrat text-sm text-N5 md:text-lg">
                                    <em>contato@lidericonsultoria.com</em>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-5">
                            ...
                            <div className="flex flex-col justify-center items-start gap-2">
                                ...
                                <p className="font-Montserrat text-sm text-N5 md:text-lg">
                                    <em>rua, nº, bairro, João Pessoa-PB; 58050-725</em>
                                </p>
                            </div>
                        </div>
