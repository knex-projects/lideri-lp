...
const CasesSection = () => {
    return (
        <section id="cases" className="font-montserrat">
            <div className="w-[75%] mx-auto mt-[90px]">
                <div className="w-[577px] h-[190px]">
                    <p className="text-[20px] tracking-[25%] leading-[100%]">
                        • Portfolio e Resultados
                    </p>
                    <div className="flex items-center">
                        <div className="w-[64px] h-[64px] mr-[16px]">
                            <IconFolder />
                        </div>
                        <h1 className="font-impact font-bold text-[76px] leading-[82px]">
            ...
            <div className="flex flex-wrap justify-center grid-cols-1 w-[75%] mx-auto md:grid-cols-2 lg:grid-cols-3 gap-[30px] justify-items-center">
