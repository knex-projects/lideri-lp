...
export default function MapWrapper() {
  return (
    <div className=" w-full sm:h-[1014px] min-h-[860px] bg-N1 flex flex-col justify-baseline text-center sm:justify-center sm:items-center py-[40px] sm:py-20 px-[12.5%] max-sm:px-[26px]">
