...
export default function MapWrapper() {
  return (
    <div className=" w-full sm:h-[1014px] min-h-[860px] flex flex-col justify-baseline text-center sm:justify-center sm:items-center py-[40px] sm:py-20 px-[12.5%] max-sm:px-[26px]">
      ...
      <p className='sm:text-[16px] text-[14px] w-fit pb-[81px] max-w-[361px]  sm:max-w-[553px] text-N5 font-poppins '>Veja a seguir os países em que já trabalhamos representados em mapa.</p>
