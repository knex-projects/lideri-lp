          ...
          {isEditor && (
            <div className="lg:hidden mt-4 pt-4 border-t border-gray-200 flex flex-col gap-2">
              <button
                type="button"
                onClick={() =>
                  window.dispatchEvent(new Event("editor:save-draft"))
                }
                className=" border-2 border-[#87240E] flex items-center gap-3 px-3 py-3 rounded-lg font-medium text-xl lg:text-2xl transition-all duration-200  text-[#87240E] hover:bg-gray-800 "
              >
                Salvar rascunho
              </button>
              <button
        ...
        <div className="relative flex lg:flex-col lg:gap-4 lg:border-[0.0625rem] lg:rounded-[0.5rem] lg:py-3 lg:px-4 lg:border-N4 lg:w-full">
          ...
          >
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-semibold text-N8 truncate">
                Admin Líderi
              </span>
