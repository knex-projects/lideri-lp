...
export const ProjectCard = ({ title, description, imageSrc }: ProjectCardProps) => {
  return (
    <div className="group relative flex flex-col w-full max-w-[360px] md:min-w-[400px] md:max-w-[400px] md:w-[400px] lg:min-w-[440px] lg:max-w-[440px] lg:w-[440px] min-h-[353px] h-auto min-[412px]:min-h-[317px] min-[412px]:max-h-[317px] min-[412px]:h-[317px] md:min-h-[330px] md:max-h-[330px] md:h-[330px] lg:min-h-[311px] lg:max-h-[311px] lg:h-[311px] rounded-[8px] shadow-[2px_2px_8px_rgba(0,0,0,0.4)] hover:shadow-[0px_1px_8px_#87240E] transition-shadow duration-300 overflow-hidden shrink-0 bg-transparent cursor-pointer">
      ...
      <div className="w-full flex-1 md:flex-none md:h-[218px] lg:h-[199px] p-[24px] flex flex-col justify-between shrink-0 bg-white">
        <div className="flex flex-col gap-[12px] mt-[-12px] mb-[12px]">
          <h3 className="text-[16px] md:text-[17px] lg:text-[18px] leading-[24px] md:leading-[26px] lg:leading-[28px] font-[540] text-N8 flex items-center gap-[8px] font-bold font-zodiak m-0 p-0">
          ...
          <p className="text-N5 text-[14px] leading-[20px] m-0 p-0 line-clamp-none md:line-clamp-3 font-poppins">
            {description}
          </p>
        </div>
