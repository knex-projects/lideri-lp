...
const cases = [
    ...
    },
    {
        ...
        entryEstrategy:
            "A estratégia priorizou a construção de uma narrativa de impacto social alinhada à qualidade do produto, identificando segmentos internacionais dispostos a pagar mais por peças autênticas e sustentáveis. Desenvolvemos canais de venda B2B e parcerias com boutiques e marketplaces que valorizam o artesanato brasileiro.",
        marketObstacles:
            "Para artesanato, as maiores barreiras são a certificação de origem, o custo de frete e a percepção de valor em mercados estrangeiros. Também há o desafio de adaptar formatos e embalagens ao transporte internacional, reduzindo danos e custos sem perder a identidade cultural.",
        scalability:
    ...
    },
    {
        ...
        entryEstrategy:
            "A estratégia combinou o fortalecimento do artesão como marca com a profissionalização do processo de exportação. Foram criados pacotes de produtos adaptados para o comércio exterior e traçados roteiros de workshops e feiras internacionais para gerar visibilidade e testar canais comerciais.",
        marketObstacles:
