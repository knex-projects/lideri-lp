  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-loginImage bg-black bg-cover px-4" >
      ...
      <input
        type="email"
        {...register("email")}
        className={`w-full p-2.5  h-12 pl-10 border rounded-lg focus:ring-blue-500 focus:border-blue-500 transition ${
      ...
      />
          ...
          <div>
            ...
            <input
              type="password"
              {...register("password")}
              className={`mt-1 w-full h-12 p-2.5 border rounded-lg focus:ring-R5 focus:border-R5 transition ${
